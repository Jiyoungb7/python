...
dic = {'name':'hon,gil-dong', 'phone':'010-1234-1234', 'friends':['Alice', 'Smith', 'Jhone']}
...
print(dic.items())
# list로 변환해 보면 list 안에 각 키와 값이 튜플로 저장되어 있음을 알 수 있다.
li = list(dic.items())
print(li)
...
for name in members.keys():
    if members[name] >= 90:
        print(f'90 이상인 사람 : {name}')

print('and')

for name in members.items():
    if name[1] >= 90:
        print(f'90 이상인 사람 : {name[0]}')
